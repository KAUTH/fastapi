...
@needs_py39
def test_websocket_handle_disconnection(app: FastAPI):
    client1 = TestClient(app)
    client2 = TestClient(app)

    with client1.websocket_connect("/ws/1234") as connection, client2.websocket_connect("/ws/5678") as connection_two:
